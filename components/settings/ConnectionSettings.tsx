    ...
    <div className="settings-stack credential-settings">
      ...
      >
        ...
        >
          <section hidden={selected !== "hermes"} aria-label="Hermes 憑證">
            ...
            <label className="check-row">
              <input
                ...
                onChange={(e) =>
                  toggleClear("HERMES_API_KEY", e.target.checked)
                }
              />
              清除已存 Hermes 金鑰
            </label>
          ...
          <section
            hidden={selected !== "workspace"}
            aria-label="Workspace MCP 橋接"
          >
            ...
            <label className="check-row">
              <input
                ...
                onChange={(e) =>
                  toggleClear("MCP_BRIDGE_TOKEN", e.target.checked)
                }
              />
              清除已存橋接權杖
            </label>
          ...
          >
            ...
            <label className="check-row">
              <input
                ...
                onChange={(e) =>
                  toggleClear("GALLEY_MCP_TOKEN", e.target.checked)
                }
              />
              清除已存 GALLEY 權杖
            </label>
          ...
          <section hidden={selected !== "atlas"} aria-label="場圖 Atlas MCP">
            ...
            <label className="check-row">
              <input
                ...
                onChange={(e) =>
                  toggleClear("ATLAS_MCP_TOKEN", e.target.checked)
                }
              />
              清除已存場圖權杖
            </label>
          ...
          >
            ...
            <label className="check-row">
              <input
                ...
                onChange={(e) =>
                  toggleClear("FRAMELAB_MCP_TOKEN", e.target.checked)
                }
              />
              清除已存 FrameLab 權杖
            </label>
          ...
          <section hidden={selected !== "lumen"} aria-label="Lumen 創作台">
            ...
            <label className="check-row">
              <input
                ...
                onChange={(e) =>
                  toggleClear("LUMEN_MCP_TOKEN", e.target.checked)
                }
              />
              清除已存 Lumen 權杖
            </label>
          ...
          <section hidden={selected !== "xunhe"} aria-label="訊核即時情報 MCP">
            ...
            <label className="check-row">
              <input
                ...
                onChange={(e) =>
                  toggleClear("XUNHE_MCP_TOKEN", e.target.checked)
                }
              />
              清除已存訊核權杖
            </label>
          ...
          <section hidden={selected !== "zeabur"} aria-label="Zeabur 部署">
            ...
            <label>
              ...
              <span className="secret-hint">
                {secretHint(
                  data?.fields.ZEABUR_API_TOKEN || data?.zeabur?.token,
                )}
              </span>
              <input
                type="password"
            ...
            <label className="check-row">
              <input
                ...
                onChange={(e) =>
                  toggleClear("ZEABUR_API_TOKEN", e.target.checked)
                }
              />
              清除已存 Zeabur 權杖
            </label>
              ...
              <button
                ...
                onClick={() =>
                  void runZeabur({ action: "redeploy" }, (result) =>
                    setNotice(
                      "已要求重新部署：" + String(result.status || "已送出"),
                    ),
                  )
                }
              >
