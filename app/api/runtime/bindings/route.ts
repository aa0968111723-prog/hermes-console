...
export const POST = route(async req => { const owner = authenticate(req, true, true); return respond({ binding: saveRuntimeBinding(owner, input.parse(await jsonBody(req, 20_000))) }, 201); });
